...
fn generate_flat_bindings() -> PathBuf {
    ...
    cbindgen = cbindgen.opaque_owned_struct(pq!(ZZBytes), pq!(z_zbytes_t));
    ...
    cbindgen = cbindgen.opaque_owned_struct(pq!(ZSample), pq!(z_sample_t));
    ...
    cbindgen = cbindgen.opaque_owned_struct(pq!(ZReply), pq!(z_reply_t));
    ...
    cbindgen = cbindgen.opaque_data_struct(pq!(ZTimestamp), pq!(z_timestamp_t));
    ...
    cbindgen = cbindgen.opaque_data_struct(pq!(ZZenohId), pq!(z_zenoh_id_t));
    ...
    cbindgen = cbindgen.opaque_owned_struct(pq!(ZEncoding), pq!(z_encoding_t));
    ...
    let opaque = prebindgen_opaque_types::OpaqueTypes::new(zenoh_flat::MANIFEST_DIR)
        ...
        .add(pq!(zenoh_flat::ZZenohId), pq!(z_zenoh_id_t))
        .add(pq!(zenoh_flat::ZEncoding), pq!(z_encoding_t))
        .generate()
